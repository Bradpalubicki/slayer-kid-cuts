...
import { ChevronDown, HelpCircle, Calendar, Phone, Brain, Scissors, Gift, Clock, DollarSign, MapPin } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Find answers to common questions about our sensory-friendly salon, services, and what to expect.
            </p>
          </motion.div>
        </div>
      </section>
