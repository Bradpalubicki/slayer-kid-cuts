...
const services: ServiceType[] = [
  {
    ...
    price: "$45",
    priceNum: 45,
    description: "Full sensory accommodations, intake questionnaire",
    icon: Shield,
  },
  {
    id: "kids-cut",
    ...
    price: "$30",
    priceNum: 30,
    description: "Calm, private haircut experience",
    icon: Scissors,
  },
  {
    id: "buzz-cut",
    ...
    price: "$20",
    priceNum: 20,
    description: "Quick buzz cut or ends trim",
    icon: Scissors,
  },
  {
    id: "bang-trim",
