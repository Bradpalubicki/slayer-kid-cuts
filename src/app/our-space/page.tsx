...
function SensorySuiteFloorPlan() {
  return (
    <div className="bg-gradient-to-br from-[#9B5DE5]/5 to-[#00F5D4]/5 rounded-3xl p-8 border-2 border-[#9B5DE5]/20">
      <div className="max-w-md mx-auto space-y-4">
        {/* Private Entrance */}
        <div className="flex items-center gap-3 bg-[#00F5D4]/20 rounded-xl p-4 border-2 border-[#00F5D4]/30">
          <DoorOpen className="w-8 h-8 text-[#00F5D4]" />
          <div>
            <p className="font-bold text-[#00F5D4]">Private Entrance</p>
        ...
        {/* Styling Area */}
        <div className="bg-[#9B5DE5]/10 rounded-xl p-4 border-2 border-[#9B5DE5]/30">
          <h4 className="font-bold text-[#9B5DE5] mb-2">Styling Area</h4>
          <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
        ...
        {/* Shampoo Sink */}
        <div className="bg-[#00BBF9]/10 rounded-xl p-4 border-2 border-[#00BBF9]/30">
          <h4 className="font-bold text-[#00BBF9] mb-2">Private Shampoo Sink</h4>
        ...
        {/* Calm Corner */}
        <div className="bg-[#FF6B9D]/10 rounded-xl p-4 border-2 border-[#FF6B9D]/30">
          <h4 className="font-bold text-[#FF6B9D] mb-2">Calm Corner / Break Space</h4>
          <div className="grid grid-cols-2 gap-2 text-sm text-gray-600">
        ...
        <div className="flex items-center gap-3 bg-[#00F5D4]/20 rounded-xl p-4 border-2 border-[#00F5D4]/30">
          <DoorOpen className="w-8 h-8 text-[#00F5D4]" />
          <div>
            <p className="font-bold text-[#00F5D4]">Private Exit</p>
...
function MainSalonFloorPlan() {
  return (
    <div className="bg-gradient-to-br from-[#FF6B9D]/5 to-[#00BBF9]/5 rounded-3xl p-8 border-2 border-gray-200">
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              ...
              <div key={item.label} className="flex items-center gap-2 text-sm text-gray-600">
                <item.icon className="w-4 h-4 text-[#9B5DE5]" />
        ...
        {/* Open Styling Floor */}
        <div className="bg-[#FF6B9D]/10 rounded-xl p-6 border-2 border-[#FF6B9D]/30">
          <h4 className="font-bold text-[#FF6B9D] mb-3">Open Styling Floor (4 Chairs)</h4>
          <div className="grid grid-cols-4 gap-3 mb-4">
            {[1, 2, 3, 4].map((num) => (
              <div key={num} className="bg-white rounded-lg p-3 text-center border border-gray-200">
                <Scissors className="w-6 h-6 mx-auto text-[#FF6B9D] mb-1" />
        ...
        {/* Private Suites */}
        <div className="bg-[#00BBF9]/10 rounded-xl p-6 border-2 border-[#00BBF9]/30">
          <h4 className="font-bold text-[#00BBF9] mb-3">Private Suites (4 Suites)</h4>
          <div className="grid grid-cols-4 gap-3 mb-4">
            {[1, 2, 3, 4].map((num) => (
              <div key={num} className="bg-white rounded-lg p-3 text-center border border-gray-200">
                <DoorOpen className="w-5 h-5 mx-auto text-[#00BBF9] mb-1" />
        ...
        {/* Connection Note */}
        <div className="bg-[#9B5DE5]/10 rounded-xl p-4 border-l-4 border-[#9B5DE5]">
          <p className="text-sm text-gray-700">
            <strong>Interior Door</strong> → Connects to Slayer&apos;s Private Sensory Suite (staff access only).
...
export default function OurSpacePage() {
  return (
    <div className="min-h-screen pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Slayer Kid Cuts was designed from the ground up with sensory-friendly experiences in mind.
      ...
      {/* Slayer's Private Sensory Suite */}
      ...
      <section className="py-16 bg-gradient-to-r from-[#00BBF9] to-[#9B5DE5] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[
              { step: 1, icon: Car, title: "Drive & Park", desc: "Pull into our parking lot. Dedicated spots near Slayer's private entrance." },
              ...
              { step: 3, icon: Sparkles, title: "We Prepare", desc: "Slayer sets up the suite exactly how your child likes it." },
            ...
            <table className="w-full border-collapse">
              ...
              <tbody>
                {[
                  ...
                  { condition: "Has graduated from needing full accommodation", recommendation: "Main Salon with Slayer", suite: false },
                ].map((row, index) => (
                  <tr key={index} className="border-b">
                    <td className="p-4 text-gray-700">{row.condition}</td>
                    <td className="p-4">
                      <Badge className={row.suite ? "bg-[#00F5D4]/10 text-[#00F5D4] border-[#00F5D4]/20" : "bg-[#FF6B9D]/10 text-[#FF6B9D] border-[#FF6B9D]/20"}>
                        {row.recommendation}
                      </Badge>
                    </td>
                  </tr>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <Card className="h-full border-2 border-dashed border-gray-300">
                <CardContent className="p-8 text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[#9B5DE5]/10 flex items-center justify-center">
                  ...
                  <Link href="/coming-soon">
                    <Button className="rounded-full bg-[#9B5DE5] text-white">
                      Join the Waitlist
                    </Button>
                  </Link>
                </CardContent>
            ...
            >
              <Card className="h-full border-2 border-dashed border-gray-300">
                <CardContent className="p-8 text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[#00F5D4]/10 flex items-center justify-center">
                    <Tv className="w-8 h-8 text-[#00F5D4]" />
                  </div>
                  ...
                  <Link href="/coming-soon">
                    <Button className="rounded-full bg-[#00F5D4] text-gray-900">
                      Get Notified
                    </Button>
                  </Link>
                </CardContent>
